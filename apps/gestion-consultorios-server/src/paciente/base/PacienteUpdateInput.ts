...
class PacienteUpdateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => TurnoUpdateManyWithoutPacientesInput,
  })
  @ValidateNested()
  @Type(() => TurnoUpdateManyWithoutPacientesInput)
  @IsOptional()
  @Field(() => TurnoUpdateManyWithoutPacientesInput, {
    nullable: true,
  })
  ...
  @ApiProperty({
    required: false,
    type: () => EstudioMedicoUpdateManyWithoutPacientesInput,
  })
  @ValidateNested()
  @Type(() => EstudioMedicoUpdateManyWithoutPacientesInput)
  @IsOptional()
  @Field(() => EstudioMedicoUpdateManyWithoutPacientesInput, {
    nullable: true,
  })
